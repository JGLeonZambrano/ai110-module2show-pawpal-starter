...
class Task:
    ...
    def mark_complete(self):
        # Changes the Task into is_complete == True
...
class Pet:
    ...
    def add_task(self, task):
        self.tasks.append(task) #Appends the entered to the Task's list

    def list_tasks(self):
        return self.tasks #Lists the entered Tasks for this specific pet
...
class Scheduler:
    ...
    def sort_by_priority(self):
        ...
        # Return the sorted list of all tasks, organized by the priority
